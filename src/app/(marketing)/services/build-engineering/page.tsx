...
const SLUG = "build-engineering";

export const metadata: Metadata = {
  title: "Build & Engineering",
  description: "Production-grade development — web development, UX engineering, CMS, AI prototyping, and Shopify.",
};

export default async function BuildEngineeringPage() {
